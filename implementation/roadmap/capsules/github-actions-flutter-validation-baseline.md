...
- [ ] Capsule exists.
- [ ] `CURRENT.md` selects this capsule as active.
- [ ] `snapshots/latest.md` records that help modal implementation is deferred pending CI parity.
- [ ] Future implementation updates hosted CI to run governance checks plus Flutter analyze/test.
- [ ] No workflow files are modified in this routing pass.
- [ ] No Flutter source, Flutter test, Firebase/backend, dependency, native platform, init, build, deploy, or help modal implementation work is introduced in this routing pass.
