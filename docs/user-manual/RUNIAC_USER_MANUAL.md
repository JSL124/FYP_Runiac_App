...
3. **Pricing** — Free and Premium compared.
...
5. **Documents** — project documents, filterable by category.

   ![Documents](screenshots/01-unregistered/web/06-documents.png){ width=95% }

6. **Document detail** — preview or download a single document.
...
8. **Sign in** — the entry point for administrators.
...
The thirteen marketing-site pages in 1.2 — Home, Features, How it works, Pricing, FAQ, Documents,
Document detail, About us, Sign in, and the four legal pages — were not re-shot for version
1.1. No change to them was reported, and they were not individually re-verified against the live
site for this revision, so they remain the version 1.0 captures and should be treated as dated
4 August 2026. The same applies to every Part 2 and Part 3 screen outside 2.8 and 2.9, and to the
